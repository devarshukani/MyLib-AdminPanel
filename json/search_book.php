<?php 
	...
	$sql = "SELECT * FROM bookdetail bd, authordetail ad, publicationdetail pd, categorydetail cd WHERE bd.CategoryID = $id AND bd.AuthorID = ad.AuthorID AND bd.PublicationID = pd.PublicationID AND bd.CategoryID = cd.CategoryID;";
