<?php
	...
	//category ma clicked specific book 
	...
	$sql = "SELECT * FROM bookdetail bd, authordetail ad, publicationdetail pd, categorydetail cd WHERE bd.BookID = $id AND bd.AuthorID = ad.AuthorID AND bd.PublicationID = pd.PublicationID AND bd.CategoryID = cd.CategoryID ;";
